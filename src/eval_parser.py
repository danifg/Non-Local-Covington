...
from transition import Covington, NewCovington, Covington2, Covington3
...
def eval(args):
    transsys_lookup = {"Cov": Covington, "NCov": NewCovington, "Cov2": Covington2, "Cov3": Covington3}
    ...
    for epoch in reversed(xrange(int(args.epochs * args.epoch_multiplier))):
        ...
        log.info('Use exclusively the model of last epoch') #Added to just use the last model
        break            
    sess.close()
