...
from transition import Covington, NewCovington, Covington2
import argparse
...
parser.add_argument('--transsys', type=str, choices=['Cov', 'NCov', 'Cov2', 'Cov3', 'DCov'], help="Transition system to use", default="Cov")
